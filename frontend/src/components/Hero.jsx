    ...
    <section id="home" className={styles.heroContainer}>
      ...
      >
        ...
        <motion.div className={styles.ctaGroup} variants={itemVariants}>
          {/* Pass intended role as router state so Login/Signup can preselect it */}
          <button className={styles.primaryCta} onClick={() => navigate('/login', { state: { role: 'Attendee' } })}>
            <Ticket size={20} />
            <span>Browse as Attendee</span>
          </button>
          <button className={styles.secondaryCta} onClick={() => navigate('/login', { state: { role: 'Organizer' } })}>
            <User size={20} />
