...
export default function LandingView({ eventList, setView, onBookEvent }) {
    ...
    <div className={styles.landingContainer}>
      ...
      <section className={styles.trendingSection}>
        <div className={styles.sectionHeader}>
          ...
          <button className={styles.exploreBtn} onClick={() => setView('attendee')}>
        ...
        <div className={styles.middleCtaBanner} onClick={() => setView('attendee')}>
      ...
      <section className={styles.featuresSection}>
        ...
        <div className={styles.featuresGrid}>
          ...
          <div className={`${styles.featureCard} glass-card`}>
            ...
            <button className={styles.roleBtnPrimary} onClick={() => setView('attendee')}>
          ...
          <div className={`${styles.featureCard} glass-card`}>
            ...
            <button className={styles.roleBtnSecondary} onClick={() => setView('organizer')}>
